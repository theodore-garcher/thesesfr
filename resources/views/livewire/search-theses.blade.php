<div>
    <div class="flex flex-auto justify-center mb-8 mt-2">
        <input wire:model="search" type="search" placeholder="Rechercher une thèse..." class="shadow appearance-none border rounded w-1/2 py-2 px-2 text-gray-700 focus:outline-none focus:shadow-outline">
    </div>
